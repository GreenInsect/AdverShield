...
function keyDown(key) {
  ...
  const btnMap={throttle:'dpadUp',brake:'dpadBrake',left:'dpadLeft',right:'dpadRight',q:'dpadQ'};
...
const KEY_MAP={'w':'throttle','arrowup':'throttle','s':'brake','arrowdown':'brake','a':'left','arrowleft':'left','d':'right','arrowright':'right','q':'q'};
...
function updatePurifyStatus(active) {
  ...
  txt.textContent=active?'APDS净化模块运行中':'净化模块待机中';
}
